...
import (
	...
	"github.com/xzl8028/xenia-server/services/filesstore"
...
func TestSendMailUsingConfigAdvanced(t *testing.T) {
	...
	var from = mail.Address{Name: "Nobody", Address: "nobody@xenia.com"}
	var replyTo = mail.Address{Name: "ReplyTo", Address: "reply_to@xenia.com"}
	var emailSubject = "Testing this email"
	var emailBody = "This is a test from autobot"
