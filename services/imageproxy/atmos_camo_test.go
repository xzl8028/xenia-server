...
func TestAtmosCamoBackend_GetImage(t *testing.T) {
	imageURL := "http://www.xenia.org/wp-content/uploads/2016/03/logoHorizontalWhite.png"
...
func TestGetAtmosCamoImageURL(t *testing.T) {
	...
	defaultSiteURL := "https://xenia.example.com"
	...
	for _, test := range []struct {
		...
		{
			Name:     "should not proxy an image on the Xenia server when a subpath is set",
			Input:    "https://xenia.example.com/static/logo.png",
