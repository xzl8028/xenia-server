...
func TestGetProxiedImageURL(t *testing.T) {
	siteURL := "https://xenia.example.com"

	imageURL := "http://www.xenia.org/wp-content/uploads/2016/03/logoHorizontal.png"
	proxiedURL := "https://xenia.example.com/api/v4/image?url=http%3A%2F%2Fwww.xenia.org%2Fwp-content%2Fuploads%2F2016%2F03%2FlogoHorizontal.png"
	...
	for _, test := range []struct {
		...
		{
			Name:     "should not proxy an image on the Xenia server",
			Input:    "https://xenia.example.com/static/logo.png",
			Expected: "https://xenia.example.com/static/logo.png",
		},
		{
...
func TestGetUnproxiedImageURL(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{
			Name:     "should not remove proxy from an image on the Xenia server",
			Input:    "https://xenia.example.com/static/logo.png",
			Expected: "https://xenia.example.com/static/logo.png",
		},
		{
