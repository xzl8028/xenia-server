...
func (a *App) trackConfig() {
	...
	a.SendDiagnostic(TRACK_CONFIG_TEAM, map[string]interface{}{
		...
		"isdefault_site_name":                       isDefault(cfg.TeamSettings.SiteName, "Xenia"),
	...
	a.SendDiagnostic(TRACK_CONFIG_PLUGIN, map[string]interface{}{
		"enable_autolink":               pluginActivated(cfg.PluginSettings.PluginStates, "xenia-autolink"),
		"enable_aws_sns":                pluginActivated(cfg.PluginSettings.PluginStates, "com.xenia.aws-sns"),
		"enable_custom_user_attributes": pluginActivated(cfg.PluginSettings.PluginStates, "com.xenia.custom-attributes"),
		...
		"enable_nps":                    pluginActivated(cfg.PluginSettings.PluginStates, "com.xenia.nps"),
		"enable_nps_survey":             pluginSetting(&cfg.PluginSettings, "com.xenia.nps", "enablesurvey", true),
		"enable_welcome_bot":            pluginActivated(cfg.PluginSettings.PluginStates, "com.xenia.welcomebot"),
