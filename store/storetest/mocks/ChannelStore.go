...
func (_m *ChannelStore) GetByDisplayName(team_id string, display_name string) (*model.Channel, *model.AppError) {
	ret := _m.Called(team_id, display_name)

	var r0 *model.Channel
	if rf, ok := ret.Get(0).(func(string, string) *model.Channel); ok {
		r0 = rf(team_id, display_name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.Channel)
		}
