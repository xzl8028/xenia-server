...
func TestOAuthComplete(t *testing.T) {
	...
	// We are going to use xenia as the provider emulating gitlab
	th.App.UpdateConfig(func(cfg *model.Config) { *cfg.ServiceSettings.EnableOAuthServiceProvider = true })
...
type XeniaTestProvider struct {
}

func (m *XeniaTestProvider) GetUserFromJson(data io.Reader) *model.User {
