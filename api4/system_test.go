...
func TestS3TestConnection(t *testing.T) {
	...
	t.Run("as system admin", func(t *testing.T) {
		...
		// `xenia-test` bucket defined by model.MINIO_BUCKET.
...
func TestRedirectLocation(t *testing.T) {
	expected := "https://xenia.com/wp-content/themes/xeniav2/img/logo-light.svg"
	...
	*th.App.Config().ServiceSettings.AllowedUntrustedInternalConnections = "127.0.0.1"
	...
	_, resp := th.SystemAdminClient.GetRedirectLocation("https://xenia.com/", "")
	CheckNoError(t, resp)
	...
	*th.App.Config().ServiceSettings.EnableLinkPreviews = false
	actual, resp = th.SystemAdminClient.GetRedirectLocation("https://xenia.com/", "")
	CheckNoError(t, resp)
