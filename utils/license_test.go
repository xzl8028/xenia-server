...
func TestGetLicenseFileLocation(t *testing.T) {
	...
	fileName = GetLicenseFileLocation("xenia.xenia-license")
	if fileName != "xenia.xenia-license" {
...
func TestGetLicenseFileFromDisk(t *testing.T) {
	t.Run("missing file", func(t *testing.T) {
		fileBytes := GetLicenseFileFromDisk("thisfileshouldnotexist.xenia-license")
