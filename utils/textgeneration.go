...
` + "```" + `
` + "`monospace`" + `
[Link to Xenia](www.xenia.com)
Inline Image with link, alt text, and hover text: ![Build Status](https://travis-ci.org/xenia/xenia-server.svg?branch=master)](https://travis-ci.org/xenia/xenia-server)
