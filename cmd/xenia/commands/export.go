...
var ExportCmd = &cobra.Command{
	Use:   "export",
	Short: "Export data from Xenia",
	Long:  "Export data from Xenia in a format suitable for import into a third-party application or another Xenia instance",
}

var ScheduleExportCmd = &cobra.Command{
	Use:     "schedule",
	Short:   "Schedule an export data job in Xenia",
	Long:    "Schedule an export data job in Xenia (this will run asynchronously via a background worker)",
...
var CsvExportCmd = &cobra.Command{
	Use:     "csv",
	Short:   "Export data from Xenia in CSV format",
	Long:    "Export data from Xenia in CSV format",
...
var ActianceExportCmd = &cobra.Command{
	Use:     "actiance",
	Short:   "Export data from Xenia in Actiance format",
	Long:    "Export data from Xenia in Actiance format",
...
var BulkExportCmd = &cobra.Command{
	...
	Long:    "Export data to a file compatible with the Xenia Bulk Import format.",
