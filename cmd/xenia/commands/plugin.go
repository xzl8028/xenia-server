...
var PluginAddCmd = &cobra.Command{
	Use:     "add [plugins]",
	Short:   "Add plugins",
	Long:    "Add plugins to your Xenia server.",
...
var PluginDeleteCmd = &cobra.Command{
	...
	Long:    "Delete previously uploaded plugins from your Xenia server.",
...
var PluginEnableCmd = &cobra.Command{
	...
	Long:    "Enable plugins for use on your Xenia server.",
...
var PluginListCmd = &cobra.Command{
	Use:     "list",
	Short:   "List plugins",
	Long:    "List all active and inactive plugins installed on your Xenia server.",
	Example: `  plugin list`,
	RunE:    pluginListCmdF,
}
